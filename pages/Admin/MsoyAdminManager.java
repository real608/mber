    ...
    implements PeerAdminProvider
{
    ...
    {
        if (!initiator.equalsIgnoreCase("automatic")) {
            if (minutes == 0) {
        ...
        implements AttributeChangeListener
    {
        ...
        public void attributeChanged (AttributeChangedEvent event)
        {
            ...
            // schedule a reboot if the blame is not equal to the automatic initiator
            if(!blame.equalsIgnoreCase(AUTOMATIC_INITIATOR)) 
            {
