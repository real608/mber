...
public class EditAccountPanel extends FlowPanel
{
    ...
    protected void updateEmail ()
    {
        ...
        if(MemberMailUtil.isValidAddress(email)) { //make sure the email is not fake or something
        _upemail.setEnabled(false);
        ...
        MsoyUI.infoNear(_msgs.emailFailed(), _upemail); // invalid email the person is trying to update with :(
       }
    }
